...
-- CreateTable
CREATE TABLE "_KitToRecipient" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_KitToRecipient_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE INDEX "_KitToRecipient_B_index" ON "_KitToRecipient"("B");
...
-- AddForeignKey
ALTER TABLE "_KitToRecipient" ADD CONSTRAINT "_KitToRecipient_A_fkey" FOREIGN KEY ("A") REFERENCES "Kit"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_KitToRecipient" ADD CONSTRAINT "_KitToRecipient_B_fkey" FOREIGN KEY ("B") REFERENCES "Recipient"("id") ON DELETE CASCADE ON UPDATE CASCADE;
